"""
This spider was written to find all the urls of muslim boys on hamariweb.com
...
class namelinks(scrapy.Spider):
    ...
    for character in string.ascii_lowercase:
        start_urls.append(f"https://hamariweb.com/names/muslim-boy-names-starting-with-{character}/page-1")
